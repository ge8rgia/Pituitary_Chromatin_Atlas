#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/3a_observed_bw.out
#SBATCH --job-name=obs_ct
...
IN="/scratch/prj/stem_cells_pituitary/georgia_atac/mouse_young_merged"
OUT="/scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/outputs/mouse_young"
