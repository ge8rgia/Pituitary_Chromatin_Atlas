#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/5_MarginalFootprints_thyro_TFmodisco.out
#SBATCH --job-name=MF_thyro
#SBATCH --gres=gpu
...
do
     MarginalFootprints \
           "mm10" \
           "fold_0" \
           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/tf_modisco_seqs/Thyrotrophs_grouping_8_up_1000000_modisco_results_0.3.tsv \
           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/outputs/mouse \
           "$cell" \
	   "allTFModisco"
done

#cell_types_list2=("Corticotrophs" "Gonadotrophs" "Lactotrophs" "Melanotrophs" "Somatotrophs" "Stem_cells" "Thyrotrophs")

#for cell in "${cell_types_list2[@]}"
#do
#     MarginalFootprints_young \
#           "mm10" \
#           "fold_0" \
#           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/representative_MA_ID_sequences.tsv \
