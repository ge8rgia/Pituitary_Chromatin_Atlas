#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/2_MergeCelltype.out
...
# 1. Define paths
sampleDir="/scratch/prj/stem_cells_pituitary/georgia_atac/mouse_split"
outDir="/scratch/prj/stem_cells_pituitary/georgia_atac/mouse_merged"
