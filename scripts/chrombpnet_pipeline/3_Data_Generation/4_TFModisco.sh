#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/4_tf_modisco_1M.out
#SBATCH --job-name=tfmo_1M
...
#groupings=("updated_consensus_chromatin_landscape_modified")
