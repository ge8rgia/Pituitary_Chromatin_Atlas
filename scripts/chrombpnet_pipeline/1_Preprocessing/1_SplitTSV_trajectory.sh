#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/1_SplitTSV_trajectory.out
...
output_directory="/scratch/prj/stem_cells_pituitary/georgia_atac/mouse_young_split_trajectory"
...
SplitTSV_trajectory "$sample_directory" "$output_directory" "$barcodes"
