...
multiBigwigSummary BED-file \
    ...
    --BED /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/outputs/mouse/Melanotrophs/contribs_bw/Melanotrophs_contribs.interpreted_regions.bed \
    ...
    -o "$OUTPUT_DIR/multibw_summary_tracks.npz" \
    -p 8

echo "Generating Pearson correlation heatmap"

plotCorrelation \
    -in "$OUTPUT_DIR/multibw_summary_tracks.npz" \
    --corMethod pearson \
    --skipZeros \
    --whatToPlot heatmap \
    --colorMap coolwarm \
    ...
    -o "$OUTPUT_DIR/correlation_pearson_tracks.pdf"
...
plotCorrelation \
    ...
    -o "$OUTPUT_DIR/correlation_spearman_tracks.pdf"
