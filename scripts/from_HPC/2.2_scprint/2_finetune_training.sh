#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/2_finetune_training.out
#SBATCH --job-name=scprint_LoRA
#SBATCH --gres=gpu
...
# Run pseudobulk training pipeline for LoRA_fold0 (finetuning)
seq2print_train \
	--config /scratch/prj/stem_cells_pituitary/Georgia/scPRINT/GSM4594389/configs/GSM4594389_LoRA_fold0.JSON \
	...
	--project scprint_seq_GSM4594389_scATAC \
	--enable_wandb
