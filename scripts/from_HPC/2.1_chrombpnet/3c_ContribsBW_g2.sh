#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/3c_ContribsBW_g2gata.out
#SBATCH --job-name=g2gata_ContribsBW
#SBATCH --gres=gpu
...
cell_type_list=("Gonadotrophs_Gata2_KO")
...
ContribsBW \
	...
	"$cell" \
        "mm10" \
        /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/mm10/atac_group_splits/grouping_2_up.bed.gz \
