#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/5_g6.out
#SBATCH --job-name=g6
#SBATCH --gres=gpu
...
# Run pipeline
cell_types_list=("Lactotrophs" "Somatotrophs" "Melanotrophs" "Corticotrophs" "Gonadotrophs" "Gonadotrophs_Gata2_KO" "Gonadotrophs_SF1_KO" "Thyrotrophs" "Stem_cells")
...
do
     MarginalFootprints \
           "mm10" \
           "fold_0" \
           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/motif_sequences_g6_up.tsv \
