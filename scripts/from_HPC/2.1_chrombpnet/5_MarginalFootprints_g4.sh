#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/5_g4.out
#SBATCH --job-name=g4
#SBATCH --gres=gpu
...
# Run pipeline
cell_types_list=("Melanotrophs" "Corticotrophs" "Gonadotrophs" "Gonadotrophs_Gata2_KO" "Gonadotrophs_SF1_KO" "Lactotrophs" "Somatotrophs" "Thyrotrophs" "Stem_cells")
...
do
     MarginalFootprints \
           "mm10" \
           "fold_0" \
           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/motif_sequences_g4_up.tsv \
