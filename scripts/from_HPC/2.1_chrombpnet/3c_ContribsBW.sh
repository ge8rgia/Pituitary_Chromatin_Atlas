#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/3c_ContribsBW_g1.out
#SBATCH --job-name=g1_ContribsBW
#SBATCH --gres=gpu
...
ContribsBW \
	...
	"$cell" \
        "mm10" \
        /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/mm10/atac_group_splits/grouping_1_up.bed.gz \
