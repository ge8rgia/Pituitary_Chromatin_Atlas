#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/5_g1.out
#SBATCH --job-name=g1
#SBATCH --gres=gpu
...
# Run pipeline
cell_types_list=("Stem_cells" "Corticotrophs" "Gonadotrophs" "Gonadotrophs_Gata2_KO" "Gonadotrophs_SF1_KO" "Lactotrophs" "Melanotrophs" "Somatotrophs" "Thyrotrophs")
...
do
     MarginalFootprints \
           "mm10" \
           "fold_0" \
           /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/motif_sequences_g1_up.tsv \
