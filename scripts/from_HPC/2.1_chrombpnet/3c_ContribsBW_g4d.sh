#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/3c_ContribsBW_g4d.out
#SBATCH --job-name=g4d_ContribsBW
#SBATCH --gres=gpu
...
ContribsBW \
	...
	"$cell" \
        "mm10" \
        /scratch/prj/stem_cells_pituitary/Georgia/ChromBPnet/data/mm10/atac_group_splits/grouping_4_down.bed.gz \
