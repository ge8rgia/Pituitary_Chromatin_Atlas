#!/bin/bash -l
#SBATCH --output=/scratch/prj/stem_cells_pituitary/Georgia/scripts/0_outputs/3c_ContribsBW_g2sf1.out
#SBATCH --job-name=g2sf1_ContribsBW
#SBATCH --gres=gpu
...
cell_type_list=("Gonadotrophs_SF1_KO")
